...
class server2{
	...
	public function table_update(array $post_array){
		...
		mysqli_query($this->con,"SET @OLD_UNIQUE_CHECKS=@@UNIQUE_CHECKS, UNIQUE_CHECKS=0;");
		mysqli_query($this->con,"SET @OLD_FOREIGN_KEY_CHECKS=@@FOREIGN_KEY_CHECKS, FOREIGN_KEY_CHECKS=0;");
		mysqli_query($this->con,"SET @OLD_SQL_MODE=@@SQL_MODE, SQL_MODE='TRADITIONAL,ALLOW_INVALID_DATES';");
		...
		//mysqli_query($this->con,"TRUNCATE table `".$table_name."`");
		...
		mysqli_query($this->con,"SET SQL_MODE=@OLD_SQL_MODE;");
		mysqli_query($this->con,"SET FOREIGN_KEY_CHECKS=@OLD_FOREIGN_KEY_CHECKS;");
		mysqli_query($this->con,"SET UNIQUE_CHECKS=@OLD_UNIQUE_CHECKS;");
